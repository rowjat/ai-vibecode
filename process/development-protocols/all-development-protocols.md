...
- `git-workflow.md`
  Branch types, starting work, rules, merge strategy, version tagging, changelog, PR process, review protocol, AI session rules, worktrees, vc-git-manager automation, merge conflict handling, CI gates, and branch protection alternatives.
