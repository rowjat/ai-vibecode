...
- 🐛 [Signaler un bug](https://github.com/rowjat/ai-vibecode/issues/new?template=1.bug_report.yml)
- 💡 [Demander une fonctionnalité](https://github.com/rowjat/ai-vibecode/issues/new?template=2.feature_request.yml)
- ⚡ [Soumettre un skill](https://github.com/rowjat/ai-vibecode/issues/new?template=3.skill_submission.yml)
- 🌐 [Ajouter une traduction](https://github.com/rowjat/ai-vibecode/issues/new?template=5.translation.yml)
